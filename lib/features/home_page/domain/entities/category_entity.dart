...
class Category extends Equatable {
  ...
  static const List<Category> fallback = [
    Category(id: 'f1', slug: 'restaurant', displayName: 'Restaurants', icon: 'restaurant', color: '0xFFFF6B57', sortOrder: 10),
    Category(id: 'f2', slug: 'fastFood', displayName: 'Fast Food', icon: 'fastfood', color: '0xFFFF9800', sortOrder: 20),
    Category(id: 'f3', slug: 'shopping', displayName: 'Shopping', icon: 'shopping_bag', color: '0xFF00B8D9', sortOrder: 30),
    Category(id: 'f4', slug: 'mall', displayName: 'Centres Commerciaux', icon: 'store_mall_directory', color: '0xFF8B5CF6', sortOrder: 40),
    Category(id: 'f5', slug: 'hotel', displayName: 'Hôtels', icon: 'hotel', color: '0xFF536DFE', sortOrder: 50),
    Category(id: 'f6', slug: 'carRental', displayName: 'Location Voiture', icon: 'directions_car', color: '0xFF3BB273', sortOrder: 60),
    Category(id: 'f7', slug: 'travelAgency', displayName: 'Voyage', icon: 'card_travel', color: '0xFF00C2A8', sortOrder: 70),
    Category(id: 'f8', slug: 'spa', displayName: 'Spa', icon: 'spa', color: '0xFF2DD4BF', sortOrder: 80),
    Category(id: 'f9', slug: 'cinema', displayName: 'Cinema', icon: 'movie', color: '0xFFE64980', sortOrder: 90),
    Category(id: 'f10', slug: 'tourism', displayName: 'Tourisme', icon: 'tour_rounded', color: '0xFF7950F2', sortOrder: 100),
  ];
