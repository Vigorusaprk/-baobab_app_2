...
class UICategory {
  ...
  IconData get icon {
    switch (category.type) { // Correction ici
      ...
      case BusinessType.fastFood: return Icons.fastfood;
      case BusinessType.shopping: return Icons.shopping_bag;
      case BusinessType.hotel: return Icons.hotel;
      case BusinessType.mall: return Icons.store_mall_directory;
      case BusinessType.carRental: return Icons.directions_car;
      case BusinessType.travelAgency: return Icons.card_travel;
      case BusinessType.spa: return Icons.spa;
      case BusinessType.cinema: return Icons.movie;
      case BusinessType.tourism: return Icons.tour_rounded;
  ...
  static final List<UICategory> allCategories =
  Category.allCategories.map((c) => UICategory(c)).toList();
}