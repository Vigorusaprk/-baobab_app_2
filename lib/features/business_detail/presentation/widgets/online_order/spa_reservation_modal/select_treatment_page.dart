      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text('${selectedTreatments.length} soin(s) sélectionné(s)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: isSmallScreen ? 14 : 16)),
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: selectedTreatments.isNotEmpty ? AppColors.primary : Colors.grey[300],
                padding: EdgeInsets.symmetric(vertical: isSmallScreen ? 14 : 16),
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
              ),
              child: Text("Continuer", style: TextStyle(fontSize: isSmallScreen ? 16 : 18, fontWeight: FontWeight.bold, color: selectedTreatments.isNotEmpty ? Colors.white : Colors.grey[600])),
            ),
          ),
        ),
