...
class _ReservationModalState extends State<ReservationModal> {
  ...
  Future<void> _saveReservation() async {
    ...
    try {
      // Créer une réservation unifiée de type restaurant
      final reservation = Reservation(
        ...
        // Champs restaurant
        tableNumber: _data.selectedTable ?? "Non spécifiée",
        floor: _selectedFloor,
        date: _data.date ?? DateTime.now(),
        time: _data.time ?? TimeOfDay.now(),
      ...
      print("Réservation confirmée pour ${_fullNameController.text} à la table ${_data.selectedTable} chez ${widget.business.name}");
