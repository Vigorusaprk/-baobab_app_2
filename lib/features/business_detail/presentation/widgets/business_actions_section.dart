...
class BusinessActionSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool canReserve =
        business.specificData['canReserve']?.toString() == "true";
    final bool hasDelivery =
        business.specificData['hasDelivery']?.toString() == "true";
    ...
    if (business.type == BusinessType.restaurant && canReserve) {
      actions.add(
        BusinessActionButton(
          ...
          onTap: () => BusinessActionNavigator.showReservationModal(
            context,
            business,
            'restaurant',
          ),
      ...
      actions.add(
        BusinessActionButton(
          ...
          onTap: () =>
              BusinessActionNavigator.showHotelRoomsList(context, business),
        ),
      );
      ...
      actions.add(
        BusinessActionButton(
          ...
          onTap: () =>
              BusinessActionNavigator.showCarRentalList(context, business),
        ),
      );
      ...
      actions.add(
        BusinessMovieActionButton(
          onTap: () =>
              BusinessActionNavigator.showCinemaMovies(context, business),
        ),
      );
    }
    ...
    final bool isFood =
        ...
        business.type == BusinessType.fastFood;
    ...
    if (business.type == BusinessType.mall) {
      actions.add(
        BusinessActionButton(
          ...
          label: "Boutiques",
          onTap: () =>
              BusinessActionNavigator.showMallStores(context, business),
        ),
      );
    }
