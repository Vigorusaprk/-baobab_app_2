...
class BusinessHeroSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          // Logo/Icône circulaire avec ombre douce
          Container(
            width: 100,
            height: 100,
          ...
          // Badges de statut (Note & Ouverture)
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              _buildBadge(
                icon: Icons.star_rounded,
                label: "${uiBusiness.business.rating} (${uiBusiness.business.reviewCount} avis)",
  ...
  Widget _buildBadge({required IconData icon, required String label, required Color color, bool isStatus = false}) {
    return Container(
